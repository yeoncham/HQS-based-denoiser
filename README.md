...
본 프로젝트는 2026 GIST Winter Internship Program 기간 동안 진행한 연구입니다. 복잡하고 풀기 어려운 이미지 복원 문제를 풀기 쉬운 두 개의 작은 문제(데이터 일치 + 노이즈 제거)로 쪼개서 번갈아 가며 푸는 **HQS(Half-Quadratic Splitting)** 알고리즘 기반의 Denoiser 및 Deblurrer 구현체니다.
